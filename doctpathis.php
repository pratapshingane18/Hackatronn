...
<body>
    ...
    <div class="col-md-2">
                    <button type="button" class="btn btn-danger btn-sm"><a href="patmed.php"><h4 class="text-white"><img src="add.png" height="25"> Add</h4></a></button>
                </div>
            </div>
     ...
     <form action="" method="post">
        ...
        <h4 class="text-center">Click Here To view <button type="submit" class="btn btn-danger btn-sm"><a href="doctpatdash.php"><h4 class="text-white">General Information</h4></a></button>
       <br><br>
