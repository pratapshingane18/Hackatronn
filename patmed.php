...
<header>
    ...
    <div class="container">
      ...
      <form action="" method="post">
          ...
          <a href="dochis.php"><button class="btn" a >Submit</button></a>
...
// }
    ...
    $sql="INSERT INTO `patient`.`medhistory` (`name`, `treatment`, `status`, `prescription`, `phone`, `Date`) VALUES ('$name', '$treatment', '$status', '$prescription', '$phone', CURRENT_TIMESTAMP);";
